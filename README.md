---
título: React Native - Arquitetura MVVM, gestão de estado global com Zustand e de cache de requisições com React Query, Hooks customizados, animações com o React Native Reanimated, upload de arquivos, gestão de estado, validações e imutabilidade.
curso: React Native
